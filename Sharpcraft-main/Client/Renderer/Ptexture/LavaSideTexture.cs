...
{
    public class LavaSideTexture : DynamicTexture
    {
        ...
        public LavaSideTexture() : base(Tile.lava.texture + 1)
        {
            this.tileSize = 2;
        }
        ...
        public override void OnTick()
        {
            ...
            for (int i1 = 0; i1 < 16; ++i1)
            {
                ...
                {
                    f3 = 0.0F;
                    int i4 = (int)(Mth.Sin(i2 * Mth.PI * 2.0F / 16.0F) * 1.2F);
                    i5 = (int)(Mth.Sin(i1 * Mth.PI * 2.0F / 16.0F) * 1.2F);
